        ...
        */
        ...
        export.setOnAction((new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                pickit.PrepArea newPA = new pickit.PrepArea();
                ...
                System.out.println(exportAddress);
                        newPA.exportToWord(exportAddress, tab.getImage(i));
                    }
                } catch (AWTException ex) {
                    Logger.getLogger(pickit.PickIt.class.getName()).log(Level.SEVERE, null, ex);

        ...
        */
        ...
        a1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent t) {
                 flow.getChildren().add(new ImageView(new Image("/makeplace.png"))); 
                 holderArea();
            }
        });
     ...
     return main3;
        ...
        */
        ...
        a1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            @Override
            public void handle(ActionEvent t) {
                 flow.getChildren().addAll(new StackPane(new Rectangle(200, 400, Color.CORNFLOWERBLUE),new ImageView(new Image("/makeplace.png")))); 
                 holderArea();
            }
        });
           /****************************************************/
